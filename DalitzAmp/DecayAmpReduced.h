#if !defined(DECAYAMPREDUCED)
#define DECAYAMPREDUCED
...
void DecayAmpReduced_exec( dim3 dimGrid, dim3 dimBlock, GPU_AMP_PROTO,
		           GDouble norm, GDouble A, GDouble B, GDouble C, GDouble D, GDouble E, GDouble F
                          );
...
class DecayAmpReduced : public UserAmplitude< DecayAmpReduced >{

public:
  
  DecayAmpReduced() : UserAmplitude< DecayAmpReduced >() { }

  DecayAmpReduced( const vector< string >& args );
