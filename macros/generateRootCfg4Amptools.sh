...
# root -b -x -q $MACROSFOLDER/'Eta3PiReconstruction.C(0,"root4Amptools/eta_2017_data",0,"'$tag'")'
...
# root -b -x -q $MACROSFOLDER/'Eta3PiReconstruction.C(0,"root4Amptools/mc_rec_2017_data",1,"'$tag'")'
