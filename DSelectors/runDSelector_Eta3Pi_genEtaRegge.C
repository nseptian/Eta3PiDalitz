...
void runDSelector_Eta3Pi_genEtaRegge(){
    ...
    dirName = "/d/grid17/septian/GlueX_MC/nseptian_GenEtaRegge_Eta3Pi_2018-01_10M_3858/trees/tree_eta__eta_pi0pippim__B4_M17_M7_genEtaRegge/";
    dSelectorName = "DSelector_Eta3Pi_Tree_genEtaRegge.C";
    treeName = "eta__eta_pi0pippim__B4_M17_M7_Tree";
    files = SelectRootFiles(dirName, "tree_eta__eta_pi0pippim__B4_M17_M7_genEtaRegge_0", 40856, 42577, "_decay_evtgen.root");
